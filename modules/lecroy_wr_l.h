...
#if ! defined LECROY_WR_L_HEADER
#define LECROY_WR_L_HEADER
...
int lecroy_wr_l_init_hook(        void );
int lecroy_wr_l_test_hook(        void );
int lecroy_wr_l_end_of_test_hook( void );
int lecroy_wr_l_exp_hook(         void );
int lecroy_wr_l_end_of_exp_hook(  void );
void lecroy_wr_l_exit_hook(       void );
...
#endif /* ! defined LECROY_WR_L_HEADER */
