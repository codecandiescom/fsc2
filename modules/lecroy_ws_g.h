...
int lecroy_ws_g_init_hook(       void );
int lecroy_ws_g_test_hook(       void );
int lecroy_ws_g_exp_hook(        void );
int lecroy_ws_g_end_of_exp_hook( void );
void lecroy_ws_g_exit_hook(      void );
...
#endif /* ! defined LECROY_WS_G_HEADER */
