...
keithley2612b_get_state( void )
{
    ...
    if ( strcmp( model, "2601A\n" ) )
        print( WARN, "Module was compiled for a 2601A but device reports it's "
               "a %s.\n", model );
#elif defined _2601B
    if ( strcmp( model, "2601B\n" ) )
        print( WARN, "Module was compiled for a 2601B but device reports it's "
               "a %s.\n", model );
#elif defined _2602A
    if ( strcmp( model, "2602A\n" ) )
        print( WARN, "Module was compiled for a 2602A but device reports it's "
               "a %s.\n", model );
#elif defined _2602B
    if ( strcmp( model, "2602B\n" ) )
        print( WARN, "Module was compiled for a 2602B but device reports it's "
               "a %s.\n", model );
#elif defined _2604B
    if ( strcmp( model, "2604B\n" ) )
        print( WARN, "Module was compiled for a 2604B but device reports it's "
               "a %s.\n", model );
#elif defined _2611A
    if ( strcmp( model, "2611A\n" ) )
        print( WARN, "Module was compiled for a 2611A but device reports it's "
               "a %s.\n", model );
#elif defined _2611B
    if ( strcmp( model, "2611B\n" ) )
        print( WARN, "Module was compiled for a 2611B but device reports it's "
               "a %s.\n", model );
#elif defined _2612A
    if ( strcmp( model, "2612A\n" ) )
        print( WARN, "Module was compiled for a 2612A but device reports it's "
               "a %s.\n", model );
#elif defined _2612B
    if ( strcmp( model, "2612B\n" ) )
        print( WARN, "Module was compiled for a 2612B but device reports it's "
               "a %s.\n", model );
#elif defined _2614B
    if ( strcmp( model, "2614B\n" ) )
        print( WARN, "Module was compiled for a 2614B but device reports it's "
               "a %s.\n", model );
#elif defined _2634B
    if ( strcmp( model, "2634B\n" ) )
        print( WARN, "Module was compiled for a 2634B but device reports it's "
               "a %s.\n", model );
#elif defined _2635A
    if ( strcmp( model, "2635A\n" ) )
        print( WARN, "Module was compiled for a 2635A but device reports it's "
               "a %s.\n", model );
#elif defined _2635B
    if ( strcmp( model, "2635B\n" ) )
        print( WARN, "Module was compiled for a 2635B but device reports it's "
               "a %s.\n", model );
#elif defined _2636A
    if ( strcmp( model, "2636A\n" ) )
        print( WARN, "Module was compiled for a 2636A but device reports it's "
               "a %s.\n", model );
#elif defined _2636B
    if ( strcmp( model, "2636B\n" ) )
        print( WARN, "Module was compiled for a 2636B but device reports it's "
               "a %s.\n", model );
#endif
