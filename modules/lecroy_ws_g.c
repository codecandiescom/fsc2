...
int
lecroy_ws_g_init_hook( void )
{
    size_t i;


    /* Set global variable to indicate that GPIB is needed */
...
int
lecroy_ws_g_end_of_exp_hook( void )
{
    lecroy_ws_finished( );
    return 1;
}
