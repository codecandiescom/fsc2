...
static void
sr810_get_xy_auto_data( double * data,
                        long *   channels,
                        int      num_channels )
{
    int i, nk;
...
static double
sr810_set_mod_freq( double freq )
{
    char buffer[ 40 ];
    double real_freq;
...
static long
sr810_set_harmonic( long harmonic )
{
    char buffer[ 20 ];
...
static double
sr810_set_mod_level( double level )
{
    char buffer[ 50 ];
...
static long
sr810_set_sample_time( long st_index )
{
    char cmd[ 100 ];
...
static void
sr810_set_display_channel( long type )
{
    char cmd[ 100 ];
