...
#define TDS744A_CPL_INVALID       -1   /* Input coupling for data channel */
#define TDS744A_CPL_AC_1_MOHM     0    /* (don't change the sequence!) */
#define TDS744A_CPL_DC_1_MOHM     1
#define TDS744A_CPL_DC_50_OHM     2
#define TDS744A_CPL_GND           3
#define TDS744A_CPL_AC_50_OHM     4

#define TDS744A_BWL_INVALID      -1    /* Bandwidth limiter settings */
#define TDS744A_BWL_OFF           0
#define TDS744A_BWL_20MHZ         1
#define TDS744A_BWL_100MHZ        2
#define TDS744A_BWL_250MHZ        3
...
#define TDS744A_TEST_COUPLING     TDS744A_CPL_DC_50_OHM     
#define TDS744A_TEST_BANDWIDTH    TDS744A_BWL_OFF
...
int tds744a_get_coupling( int /* channel */ );

void tds744a_set_coupling( int /* channel */,
                           int /* coup    */ );

int tds744a_get_bandwidth( int /* channel */ );

void tds744a_set_bandwidth( int /* channel   */,
                            int /* bandwidth */ );
