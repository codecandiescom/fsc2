#!/usr/bin/perl
# -*- cperl -*-
# Generated by fsc2_guify from tresr_j.EDL on Fri Apr 11 11:58:52 CEST 2008
...
# === START_FIELD float [ 0 : 139022.24 ] [ 80000 ] "Start field" "G"
...
# === END_FIELD float [ 0 : 139022.24 ] [ 80500 ] "End field" "G"
...
# === SIGNAL_FIELD float [ 0 : 139022.24 ] [ 80050 ]  "Signal start field\n(for laser correction)" "G"
...
sub write_out {
    ...
    print $fh "/* \$Id: tresr_j.EDL 8019 2007-01-06 18:31:15Z jens \$ */
...
sub store_defs {
    ...
    if (     $SIGNAL_FIELD{ value } =~ /^[+-]?((\d+(\.(\d+)?)?)|(\.\d+))([eE][+-]?\d+)?$/o
    ...
    if (     $PRETRIGGER{ value } =~ /^[+-]?((\d+(\.(\d+)?)?)|(\.\d+))([eE][+-]?\d+)?$/o
