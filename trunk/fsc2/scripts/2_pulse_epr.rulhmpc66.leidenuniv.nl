#!/usr/bin/perl
# -*- cperl -*-
# Generated by fsc2_guify from 2_pulse_epr.EDL on Fri Dec 19 21:02:26 CET 2003
...
# === PULSE_DIST int [ 60 : 167772150 ] [ 400 ] "Pulse distance" "ns"
my %PULSE_DIST;
...
N_Points = int( ( end_field - start_field ) / field_step ) + 1;
N_Avg  = 10;
I;
data;
File;
