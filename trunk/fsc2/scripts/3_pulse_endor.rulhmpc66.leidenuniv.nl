#!/usr/bin/perl
# -*- cperl -*-
# Generated by fsc2_guify from 3_pulse_endor.EDL on Fri Dec 19 21:02:18 CET 2003
...
# === REP_TIME float [ 50 : ] [ 50 ] "Repetition time" "ms"
my %REP_TIME;
...
# === P2_P3_DIST int [ 60 : 167772150 ] [ 2000 ] "P2-P3 distance" "ns"
my %P2_P3_DIST;
...
N_Points = int( ( end_freq - start_freq ) / freq_step ) + 1;
N_Avg  = $NUM_AVG;
I;
data;
File;
...
pulser_show_pulses( );
init_1d( 1, N_Points, start_freq, freq_step,
