#!/usr/bin/perl
# -*- cperl -*-
# Generated by fsc2_guify from 3_pulse_endor_w.EDL on Wed Sep 27 20:46:07 CEST 2006
...
# === PULSE_2_DEFENSE float [ 0 : ] [ 1 ] "End of MW pulse to\nend of defense\npulse distance" "us"
...
$PULSE_2_DEFENSE{ tk_unit } = $PULSE_2_DEFENSE{ tk_frame }->Label( -text => "us",
-width => 5 );
...
# === FIELD float [ 0 : 114304 ] [ 35000 ] "Field" "G"
...
# === else
        ...
        print $fh "pulser_minimum_defense_distance( $PULSE_2_DEFENSE us );
";
# === endif
    }
