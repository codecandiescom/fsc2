#!/usr/bin/perl
# -*- cperl -*-
# Generated by fsc2_guify from 3_pulse_endor_w.EDL on Sat Mar 28 12:15:20 CET 2009
...
sub write_out {
    ...
    print $fh "/* \$Id: 3_pulse_endor_w.EDL 8121 2008-05-14 20:22:15Z jens \$ */
...
# === endif
    ...
    print $fh "                }
	        ...
	        fsave( File2,
				   \"\\n\"
	               \"% Date:                   # #\\n\"
	               \"% Script:                 3_pulse_endor (W-band, Leiden)\\n\"
	               \"% Field:                  # G\\n\"
	               \"% Start frequency:        # MHz\\n\"
	               \"% End frequency:          # MHz\\n\"
	               \"% Frequency step:         # MHz\\n\"
