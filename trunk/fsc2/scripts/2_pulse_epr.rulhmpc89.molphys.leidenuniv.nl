#!/usr/bin/perl
# -*- cperl -*-
# Generated by fsc2_guify from 2_pulse_epr_w.EDL on Mon Aug 27 16:57:12 CEST 2007
...
sub write_out {
    ...
    print $fh "/* \$Id: 2_pulse_epr_w.EDL 8051 2007-07-08 23:09:47Z jens \$ */
...
# === endif
    ...
    print $fh "                }
	        ...
	        fsave( File2,
	               ...
	               int( P2.LENGTH / 1 ns ), int( p1_to_p2_dist / 1 ns ),
				   N_Avg, J );
        }
