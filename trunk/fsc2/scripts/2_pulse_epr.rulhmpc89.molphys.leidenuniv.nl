#!/usr/bin/perl
# -*- cperl -*-
# Generated by fsc2_guify from 2_pulse_epr_w.EDL on Sat Sep 29 17:43:05 CEST 2007
...
sub write_out {
    ...
    print $fh "/* \$Id: 2_pulse_epr_w.EDL 8085 2007-09-13 06:27:26Z jens \$ */
...
# === else
        ...
        display_1d( N_Points - I + 1, data[ 1, J, N_Points - I + 1 ], 1,
					N_Points - I + 1, data[ 1, J, N_Points - I + 1 ], 2,
                    N_Points - I + 1, avg[ 1, N_Points - I + 1 ], 3,
                    N_Points - I + 1, avg[ 2, N_Points - I + 1 ], 4 );
";
# === endif
    }
...
# === endif
    ...
    print $fh "		avg[ I ] = add_to_average( avg[ I ], data[ J, I ], J );
		L += 1;
        display_1d( I, data[ J, I ], 1, I, avg[ I ], 2 );
";
# === else
    } else {
        print $fh "";
...
# === else
        ...
        print $fh "            fsave( File2, \"#\", field[ N_Points - I + 1 ] );
";
# === endif
    }
...
# === else
        ...
        print $fh "    FOR K = N_Points - L + 1 : N_Points {
";
# === if ( ADC_CHANNELS eq "0 and 1" )
    if ( eval { ( $ADC_CHANNELS eq "0 and 1" ) } ) {
        print $fh "        fsave( File1, \"#,#,#\\n\", field[ N_Points - K + 1 ],
