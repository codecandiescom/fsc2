#!/usr/bin/perl
# -*- cperl -*-
# Generated by fsc2_guify from 3_pulse_epr_j.EDL on Mon Aug 27 16:57:12 CEST 2007
...
sub write_out {
    ...
    print $fh "/* \$Id: 3_pulse_epr_j.EDL 8013 2007-01-02 00:26:16Z jens \$ */
...
# === endif
    ...
    print $fh "				FOR K = 1 : J {
			...
			fsave( File2,
				   ...
				   round( p1_to_p2_dist / 1 ns ),
                   round( p2_to_p3_dist / 1 ns ),
