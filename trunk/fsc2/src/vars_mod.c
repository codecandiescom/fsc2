...
static Var_T *vars_mod_i( Var_T *v1, Var_T *v2, bool exc );
static Var_T *vars_int_var_mod( Var_T *v1, Var_T *v2, bool exc );
static Var_T *vars_float_var_mod( Var_T *v1, Var_T *v2, bool exc );
static Var_T *vars_int_arr_mod( Var_T *v1, Var_T *v2, bool exc );
static Var_T *vars_float_arr_mod( Var_T *v1, Var_T *v2, bool exc );
static Var_T *vars_ref_mod( Var_T *v1, Var_T *v2, bool exc );
