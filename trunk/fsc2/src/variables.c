...
Var_T *
vars_push_matrix( Var_Type_T type,
                  int        dim,
                  ... )
{
    Var_T *nv;
...
static void
vars_ref_copy_create( Var_T * nsv,
                      Var_T * src,
                      bool    exact_copy )
{
    Var_T *vd;
