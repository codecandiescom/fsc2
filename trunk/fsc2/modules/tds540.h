...
double tds540_get_area( int channel, Window_T *w, bool use_cursor );
void tds540_get_curve( int channel, Window_T *w, double **data, long *length,
					   bool use_cursor );
double tds540_get_amplitude( int channel, Window_T *w, bool use_cursor );
void tds540_free_running( void );
void tds540_lock_state( bool lock );
void tds540_copy_curve( int src, int dest );
