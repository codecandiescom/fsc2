...
#define LECROY9424E_TEST_TIMEBASE     1.0e-3     /* 1 ms per division*/
...
#define LECROY9424E_TEST_TRIG_DELAY   1.0e-2     /* 10 ms pretrigger */
...
#define LECROY9424E_TEST_TRIG_COUP    TRG_CPL_AC
#define LECROY9424E_TEST_TRIG_MODE    TRG_MODE_NORMAL
...
bool lecroy9424e_is_displayed( int channel );
bool lecroy9424e_display( int channel, int on_off );
