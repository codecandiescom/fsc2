 ...
 * the output gets returned (which may be smaller than the requested
 * voltage due to the current limit).
 * NB: when setting the voltage the program waits until the voltage
