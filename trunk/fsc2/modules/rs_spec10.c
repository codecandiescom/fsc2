...
void
rs_spec10_child_exit_hook( void )
{
...
int
rs_spec10_end_of_exp_hook( void )
{
...
Var_T *
ccd_camera_binning_method( Var_T * v )
{
    if ( v == NULL )
...
Var_T *
ccd_camera_clear_cycles( Var_T * v )
{
    long count;
...
Var_T *
ccd_camera_pixel_size( Var_T * v  UNUSED_ARG )
{
