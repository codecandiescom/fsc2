...
int
rb_pulser_w_end_of_test_hook( void )
{
...
int
rb_pulser_w_end_of_exp_hook( void )
{
    if ( rb_pulser_w.is_needed )
        rb_pulser_w_exit( );
...
Var_T *
pulser_minimum_defense_distance( Var_T * v )
{
    double s2d;
...
Var_T *
pulser_defense_pulse_mode( Var_T * v )
{
    long mode;
