...
bool lecroy9424_set_sens( int channel, double sens );
double lecroy9424_get_offset( int channel );
bool lecroy9424_set_offset( int channel, double offset );
int lecroy9424_get_coupling( int channel );
bool lecroy9424_set_coupling( int channel, int type );
...
bool lecroy9424_set_trigger_level( int channel, double level );
double lecroy9424_get_trigger_slope( int channel );
bool lecroy9424_set_trigger_slope( int channel, int slope );
int lecroy9424_get_trigger_coupling( int channel );
int lecroy9424_set_trigger_coupling( int channel, int cpl );
...
void lecroy9424_get_curve( int ch, Window_T *w, double **array, long *length );
...
void lecroy9424_window_check( Window_T *w, bool show_num );
