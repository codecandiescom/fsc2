...
double tds754a_get_area( int channel, Window_T *w, bool use_cursor );
void tds754a_get_curve( int channel, Window_T *w, double **data, long *length,
						bool use_cursor );
double tds754a_get_amplitude( int channel, Window_T *w, bool use_cursor );
