...
static NI_DAQ_INPUT ni_daq_ai_get_trigger( const char *tname,
										   const char *snippet );
static bool ni_daq_ai_get_polarity( const char *pname, NI_DAQ_POLARITY *pol );
static void ni_daq_ai_check_T_scan( double t );
static void ni_daq_ai_check_T_conv( double t, double t_scan );
