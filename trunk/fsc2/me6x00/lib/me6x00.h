...
int me6x00_continuous( int /* board */, int /* dac */,
					   int /* size */, unsigned short * /* buf */ );
int me6x00_continuous_ex( int /* board */, int /* dac */,
						  int /* size */, unsigned short * /* buf */ );
int me6x00_reset( int /* board */, int /* dac */ );
int me6x00_reset_all( int /* board */ );
int me6x00_set_timer( int /* board */, int /* dac */,
					  unsigned int /* ticks */ );
int me6x00_set_trigger( int /* board */, int /* dac */, int /* mode */ );
int me6x00_single( int /* board */, int /* dac */,
				   unsigned short /* val */ );
