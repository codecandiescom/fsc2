...
Var_T *
f_vrescale_1d( Var_T * v  UNUSED_ARG )
{
    int shm_id;
    long len = 0;                    /* total length of message to send */
    void *buf;
...
Var_T *
f_vrescale_2d( Var_T * v  UNUSED_ARG )
{
    int shm_id;
    long len = 0;                    /* total length of message to send */
    void *buf;
...
Var_T *
f_clearmark_2d( Var_T * v  UNUSED_ARG )
{
    long len = 0;                    /* total length of message to send */
    void *buf;
    char *ptr;
