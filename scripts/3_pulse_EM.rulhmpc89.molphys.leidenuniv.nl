#!/usr/bin/perl
# -*- cperl -*-
# Generated by fsc2_guify from 3_pulse_EM_w.EDL on Sat Mar 28 12:15:19 CET 2009
...
# === P2_P3_DIST int [ 70 : 167772150 ] [ 400 ] "Init. P2-P3 distance" "ns"
...
sub write_out {
    ...
    print $fh "/* \$Id: 3_pulse_EM_w.EDL 8121 2008-05-14 20:22:15Z jens \$ */
...
fsave( File,
	   \"\\n\"
	   \"% Date:                   # #\\n\"
	   \"% Script:                 3_pulse_EM (W-band, Leiden)\\n\"
	   \"% Field:                  # G\\n\"
	   \"% Repetition time:        # ms\\n\"
