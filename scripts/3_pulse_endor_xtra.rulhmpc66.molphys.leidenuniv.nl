#!/usr/bin/perl
# -*- cperl -*-
# Generated by fsc2_guify from 3_pulse_endor_xtra_j.EDL on Sat Mar 28 15:24:45 CET 2009
...
# === if ( START_FREQ <= END_FREQ )
    if ( eval { ( $START_FREQ <= $END_FREQ ) } ) {
        print $fh "init_1d( 3, N_Points, start_freq / 1 MHz, freq_step / 1 MHz,
         \"RF frequency [MHz]\", \"Echo amplitude [a.u.]\" );
";
# === else
    } else {
        print $fh "init_1d( 3, N_Points, end_freq / 1 MHz, - freq_step / 1 MHz,
         \"RF frequency [MHz]\", \"Echo amplitude [a.u.]\" );
";
# === endif
    }
